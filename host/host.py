...
class Api(WindowChromeMixin):
    ...
    def set_suite_language(self, lang: str = "fr") -> dict:
        ...
        QrTools_updater.write_user_settings_merge({"language": key})
        return {"ok": True, "language": key}

    def set_update_check_pref(self, enabled: bool = True) -> dict:
        return QrTools_updater.set_github_update_check(bool(enabled))

    def open_release_page(self, url: str = "") -> dict:
        return QrTools_updater.open_release_url(url or "")
